...
export default function HeroResetSuccess() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${bg})`, fontFamily: "'Poppins', sans-serif" }}
    >
      <div className="relative w-[90%] sm:w-[90%] md:w-[740px] md:h-[360px] lg:w-[740px] lg:h-[360px] flex items-center justify-center z-10">
        {/* Gradient Border Card */}
        <div className="relative bg-[#00000066] w-full h-full rounded-[16px] px-6 py-8 flex flex-col items-center justify-center text-center">
  ...
  >
    ...
    {/* Circle – full glow + draw animation */}
    <circle
      cx="32"
      cy="32"
      r="30"
...
<style jsx>{`
  .success-icon {
    /* extra soft outer halo – optional but nice */
...
`}</style>
          ...
          <h2 className="text-white font-medium mt-4 md:mt-6 text-[16px] md:text-[24px]">
            Thanks for signing up!
          </h2>
          <p className="text-white text-center max-w-[400px] mt-2 md:mt-3 text-[12px] md:text-[14px]">
            Your account has been successfully created.
          </p>

          {/* Back Button */}
          <Link to="/sign-in" className="flex items-center gap-2 text-white mt-5">
