...
SECRET_KEY = 'django-insecure-c$msu9exh0f8bj^jbk7a%ut1&&7dm&y%k069fj7axyms=fe4d3'
...
INSTALLED_APPS = [
    ...
    'appln', #Changed by Prakash Raj S
    'rest_framework', #changed by Prakash Raj S
    'corsheaders', #changed by Prakash Raj S
    'social_django', #changed by Prakash Raj S
]
...
SESSION_ENGINE = 'django.contrib.sessions.backends.db' #auth0 authendication session

CORS_ALLOW_ALL_ORIGINS = True #changed by Prakash Raj S
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'appln', 'templates')], #created by Prakash Raj S
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#        'NAME': '/home/ubuntu/db_data/db.sqlite3',
#    }
#}
DATABASES = {
    'default': {
        ...
        'HOST': 'stackly-ai-db.c81ekqieoxbm.us-east-1.rds.amazonaws.com',  # from RDS or your setup
        'PORT': '3306',
        'OPTIONS': {
...
# Social Authentication Settings (Google, Facebook, Apple)
#add this by Prakash raj S, Beacause of social media login
#auth0 update
...
# Google , apple, facebook OAuth Settings
...
AUTHENTICATION_BACKENDS = (
    ...
    'django.contrib.auth.backends.ModelBackend',  # Allowing standard authentication as well
)
...
ALLOWED_HOSTS = ['*', "https://www.stacklycloud.com"]
